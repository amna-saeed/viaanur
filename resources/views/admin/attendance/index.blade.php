...
<div class="att-toolbar mb-4">
    <div class="att-toolbar__left">
        <h2 class="att-toolbar__title">Student Attendance</h2>
    ...
    @if(($overview['pending_leave_count'] ?? 0) > 0)
        <a href="{{ route('admin.dashboard') }}#pending-leave-heading" class="btn admin-lms-btn-outline att-leave-btn">
...
<div class="ad-panel">
    <div class="att-search-bar">
        <form method="GET" action="{{ route('admin.attendance.index') }}" class="att-search-form">
            ...
            @if(request()->hasAny(['q', 'rate', 'sort']))
                <a href="{{ route('admin.attendance.index') }}" class="btn admin-lms-btn-outline att-search-btn">
                ...
                <tbody>
                    @forelse($students as $student)
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('admin.students.show', $student) }}" class="btn btn-sm btn-outline-primary att-row-btn">
