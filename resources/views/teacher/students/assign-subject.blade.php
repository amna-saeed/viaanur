                ...
                @if($availableSubjects->isEmpty())
                    <div class="ad-empty">
                        ...
                        @if($assignedSubjects->isEmpty())
                            No subjects are assigned to you yet. Ask the administrator to assign subjects to your teacher profile, then return here to link students.
                        @else
                            This student is already assigned to every available subject.
                        @endif
                    </div>
                @else
                    <form action="{{ route('teacher.students.store-subject', $student) }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('teacher.students.show', $student) }}" class="btn admin-lms-btn-outline">
                    ...
                    <div class="stu-subject-list">
                        @foreach($assignedSubjects as $subject)
                            <div class="stu-subject-item">
                                ...
                                <form action="{{ route('teacher.students.remove-subject', [$student, $subject]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
