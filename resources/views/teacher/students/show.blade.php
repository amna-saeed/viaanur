...
<div class="sp-hero mb-4">
    ...
    <div class="sp-hero__actions">
        <a href="{{ route('teacher.students.edit', $student) }}" class="btn sp-hero__edit-btn">
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        ...
        <form action="{{ route('teacher.students.profile-records.update', $student) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="ad-panel__body">
                    @unless($profile)
                        <div class="sp-notice sp-notice--warning">
                            ...
                            <a href="{{ route('teacher.students.edit', $student) }}" class="sp-notice__link">Edit student</a>
                        </div>
                    @else
                        @if($student->last_active_at)
        ...
        <div class="ad-panel mb-4">
            <div class="ad-panel__head sp-panel-head justify-content-between flex-wrap gap-2">
                ...
                <a href="{{ route('teacher.students.assign-subject', $student) }}" class="btn btn-sm btn-primary">
            ...
            <div class="ad-panel__body ad-panel__body--flush">
                @if(($assignedSubjects ?? collect())->isEmpty())
                    <div class="ad-empty">
                        ...
                        <a href="{{ route('teacher.students.assign-subject', $student) }}" class="sp-notice__link d-block mt-2">Assign subjects</a>
                    </div>
                @else
        ...
        <div class="ad-panel mb-4">
            ...
            <div class="ad-panel__body">
                <div class="d-grid gap-2">
                    <a href="{{ route('teacher.students.edit', $student) }}" class="btn btn-primary sp-action-btn">
                        <i class="bi bi-pencil me-2"></i>Edit Student
                    </a>
                    <a href="{{ route('teacher.students.assign-subject', $student) }}" class="btn btn-info sp-action-btn">
                        <i class="bi bi-book-half me-2"></i>Assign Subjects
                    </a>
                    <a href="{{ route('teacher.students.index') }}" class="btn admin-lms-btn-outline sp-action-btn">
